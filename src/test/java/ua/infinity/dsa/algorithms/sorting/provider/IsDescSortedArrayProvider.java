 ...
 * @author Alex Oliinyk
 */
public class IsDescSortedArrayProvider implements ArgumentsProvider {
    ...
    public Stream<? extends Arguments> provideArguments(ExtensionContext context) {
        ...
        return algorithms.stream()
                .flatMap(algorithm -> Stream.of(
                        ...
                        Arguments.of(algorithm, new Integer[] {1, 2}, false),
                        Arguments.of(algorithm, new Integer[] {2, 1}, true),
                        Arguments.of(algorithm, new Integer[] {1, 1}, true),
                        Arguments.of(algorithm, new Integer[] {1, 2, 3},  false),
                        ...
                        Arguments.of(algorithm, new Integer[] {3, 2, 1},  true),
                        Arguments.of(algorithm, new Integer[] {1, 2, 3, 4, 5}, false),
                        Arguments.of(algorithm, new Integer[] {3, 2, 1, 5, 4}, false),
                        Arguments.of(algorithm, new Integer[] {5, 2, 4, 3, 1}, false),
                        Arguments.of(algorithm, new Integer[] {5, 4, 3, 2, 1}, true),
                        Arguments.of(algorithm, new String[] {"a"}, true),
                        Arguments.of(algorithm, new String[] {"a", "aa"}, false),
                        Arguments.of(algorithm, new String[] {"aa", "a"}, true),
                        Arguments.of(algorithm, new String[] {"aa", "ab"}, false),
                        Arguments.of(algorithm, new String[] {"ab", "aa"}, true),
                        Arguments.of(algorithm, new String[] {"ab", "ab"}, true),
                        Arguments.of(algorithm, new String[] {"a", "aa", "aaa"}, false),
                        ...
                        Arguments.of(algorithm, new String[] {"aaa", "aa", "a"}, true)
                ));
    }
}
